...
test('mantém a ajuda assistida em dez segundos sem encerrar a câmera', () => {
  assert.equal(TEMPO_AJUDA_LEITURA_MS, 10000);
});
...
test('recorta o preview com pequena margem ao redor da região de leitura', () => {
  assert.deepEqual(calcularRecortePreview(1000, 500), {
    x: 68,
    y: 138,
    width: 864,
    height: 224
